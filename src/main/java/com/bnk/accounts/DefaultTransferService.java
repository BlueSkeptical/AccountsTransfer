...
public class DefaultTransferService implements TransferService {
    ...
    public Value transfer(AccountNumber accountFrom, AccountNumber to, Value amount) {
        ...
        final Transaction<Order> transaction = logWithdrawtOrder(Transaction.newInstace(), repository.account(accountFrom), amount);
    ...
    public Account withdraw(Account from, Value amount) {
        try {
            final Transaction<Order> transaction = logWithdrawtOrder(Transaction.newInstace(), from, amount);
    ...
    private Transaction<Order> logWithdrawtOrder(Transaction<Order> transaction, Account from, Value amount) {
