...
public class TransferServiceTests {
    ...
    public void should_correctly_transfer_some_amount_from_one_account_to_another() throws TransferException, NotAuhtorizedException {
        ...
        final Account account0 = new DefaultAccount(0, new OwnerName("Joe", "Doe"), new Value(100));
        final Account account1 = new DefaultAccount(1, new OwnerName("Mary", "Smith"), new Value(200));
    ...
    public void should_throw_exception_when_amount_on_destination_account_after_transfer_will_cause_overflow() {
        ...
        final Account account0 = new DefaultAccount(0, new OwnerName("Joe", "Doe"), new Value(101));
        final Account account1 = new DefaultAccount(1, new OwnerName("Mary", "Smith"), new Value(DefaultAccount.MAX_VALUE - 99));
